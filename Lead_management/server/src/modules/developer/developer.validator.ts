...
//       message: "Month required when year is provided",
//     });
//   }

//   // Date validation
//   if (data.relivingDate && data.status === "Active") {
//     ctx.addIssue({
//       path: ["relivingDate"],
//       code: z.ZodIssueCode.custom,
//       message: "Active developer cannot have relieving date",
//     });
//   }
// });
  ...
  // export const updateDeveloperSchema = developerSchema.partial();